...
import '../../flows/auth/domain/usecases/sign_in.dart' as _i34;
import '../../flows/auth/domain/usecases/sign_out.dart' as _i35;
import '../../flows/auth/domain/usecases/sign_up.dart' as _i36;
...
import '../../flows/main/domain/usecases/send_message.dart' as _i33;
...
import '../../flows/splash/presentation/pages/splash/cubit/splash_cubit.dart'
    as _i16;
import '../../navigation/app_state_cubit/app_state_cubit.dart' as _i37;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i32.PickMarkerLocationCubit>(
      () => _i32.PickMarkerLocationCubit(get<_i18.AddMarkerPointUseCase>()));
  gh.factory<_i33.SendMessageUseCase>(
      () => _i33.SendMessageUseCase(get<_i25.ChatsRepositoryI>()));
  gh.factory<_i34.SignInUseCase>(
      () => _i34.SignInUseCase(get<_i22.AuthRepositoryI>()));
  gh.factory<_i35.SignOutUseCase>(
      () => _i35.SignOutUseCase(get<_i22.AuthRepositoryI>()));
  gh.factory<_i36.SignUpUseCase>(
      () => _i36.SignUpUseCase(get<_i22.AuthRepositoryI>()));
  gh.factory<_i37.AppStateCubit>(() => _i37.AppStateCubit(
        authRepository: get<_i20.AuthRepositoryI>(),
        firebaseAuth: get<_i4.FirebaseAuth>(),
      ));
  gh.factory<_i38.ChatsCubit>(
      () => _i38.ChatsCubit(get<_i29.GetUsersChatsUseCase>()));
  gh.factory<_i39.MessagesCubit>(() => _i39.MessagesCubit(
        get<_i27.GetChatMessagesUseCase>(),
        get<_i33.SendMessageUseCase>(),
      ));
  gh.factory<_i40.SignInCubit>(
      () => _i40.SignInCubit(get<_i34.SignInUseCase>()));
  gh.factory<_i41.SignUpCubit>(
      () => _i41.SignUpCubit(get<_i36.SignUpUseCase>()));
  return get;
}
